...
//            $(".logo-container").hide("fast");
            $("#logo-nav").removeClass("foto-logo").addClass("foto-logo-min");
            $("body").removeClass("fixed-left").addClass("fixed-left-void");


        } else if (!$("#wrapper").hasClass("enlarged") && $("body").hasClass("fixed-left-void")) {
//            $(".logo-container").show("fast");
            $("#logo-nav").removeClass("foto-logo-min").addClass("foto-logo");
            ...
            Sidemenu.prototype.menuItemClick = function (e) {
                if (!$("#wrapper").hasClass("enlarged")) {
                    ...
                    if (!$(this).hasClass("subdrop")) {
                        ...
                        $("#sidebar-menu .pull-right i").removeClass("md-remove").addClass("md md-add");
