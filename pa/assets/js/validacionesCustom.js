$.validator.addMethod("espacioBlanco", function (value) {
    var espacio = value.trim();
    if (espacio === "") {
        return false;
    } else {
        return true;
    }
}, "Error, no rellene con espacios");

$.validator.setDefaults({
    errorClass: 'help-block',
    highlight: function (element) {
        $(element).closest('.form-group').addClass('has-error'); //clase error de bootstrap            

    },
    unhighlight: function (element) {
        $(element).closest('.form-group').removeClass('has-error'); //clase error de bootstrap 
    }
});
//validador de rut
...
//validador de fecha
var validarFechaSuperior = function (fechaSolicitada, fechaRequerida) {
    fechaSolicitada = formatoFechaBD(fechaSolicitada);
    fechaRequerida = formatoFechaBD(fechaRequerida);


    if (fechaSolicitada < fechaRequerida) {
        return false;
    } else {
        return true;
    }
...
jQuery.validator.addMethod("validarFechaSuperior", function (value, element) {

    return validarFechaSuperior(value, $('#fechaVRequerida').val());
}, "La fecha solicitada debe ser superior a la requerida");
...
//validar formato de fecha
  $.validator.addMethod("formatoFecha",
    ...
    "Por favor, ingrese formato de fecha correcto"
);
...
!function (a) {
    ...
    !function () {
        ...
        return this.optional(b) || /^[a-z\-.,()'" ñÑ\s]+$/i.test(a)
